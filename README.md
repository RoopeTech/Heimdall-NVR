# Foreword
What started as a tongue-in-cheek experiment with Antigravity quickly grew into something more. Frustrated by pricey commercial NVRs and unimpressed by existing free options, I set out to build my own solution.

Today, the core product is stable and has been running in parallel with my primary NVR for two weeks. I plan to actively expand it and would love to hear your suggestions.

About RoopeTech: I’m an IT professional and homelab enthusiast. While I have enough coding experience to write production-grade scripts for my day job, this codebase is primarily generated by Antigravity, with me heavily reviewing and guiding the development.
...
> **Foreword:** What started as a tongue-in-cheek experiment with Antigravity quickly grew into something more. Frustrated by pricey commercial NVRs and unimpressed by existing free options, I set out to build my own solution.
> 
> Today, the core product is stable and has been running in parallel with my primary NVR for two weeks. I plan to actively expand it and would love to hear your suggestions.
> 
> About RoopeTech: I’m an IT professional and homelab enthusiast. While I have enough coding experience to write production-grade scripts for my day job, this codebase is primarily generated by Antigravity, with me heavily reviewing and guiding the development.
